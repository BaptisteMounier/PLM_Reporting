...
- Corrections de divers problèmes pour repartir sur une base saine et fonctionnelle
*** Problème
- Commandes dans le fichier ant incompatible avec mon l'environement windows actuel
- Précédentes modifications réalisées sur un fork de la mauvaise branche du projet PLM
*** Objectif
