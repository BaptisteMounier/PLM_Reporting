...
*** Problème
- L'ajout des blocks créés par l'utilisateur dans le menu de block de gauche
*** Objectif
- Réussir à utiliser les blocks créés par l'utilisateur
- Définir tous les blocks de base nécessaires pour PLM
 - Et les séparer par exercice
** 21 avril
*** Activité
...
- Lier la liste des blocks à afficher avec l'exercice en cours
** 20 avril
*** Activité
...
- Faire le lien entre l'exercice lancé et les blocks disponibles
- Former toute la base de block
** 17 avril
*** Activité
