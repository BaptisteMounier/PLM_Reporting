...
*** Problème
- Erreur sévère windows
*** Objectif
- [X] Nettoyage du code
  - Plus de zone connu à nettoyer
- [X] Gestion de la traduction
  - Traduction des noms de sections à voir pour une prochaine implémentation
...
- [ ] Gestion de la traduction
  ...
  - Réaliser et en état stable pour le reste
- [ ] Mise à jour l'API/instructions
  - Je ne retrouve pas l'exercice qui m'avait fait voir le problème
** 08 juin
*** Activité
- Rapport de stage
...
- [ ] Nettoyage du code
- [ ] Gestion de la traduction
- [ ] Mise à jour de l'API/instructions pour Blockly
** 05 juin
*** Activité
- Rapport de stage
...
- [ ] Nettoyage du code
- [ ] Gestion de la traduction
  - Vérifier que la traduction est correct
  - Regarder pour la traduction des noms de sections
- [ ] Mise à jour de l'API/instructions pour Blokly
** 04 juin
*** Activité
- Rapport de stage
...
- [ ] Nettoyage du code
- [ ] Gestion de la traduction
  - Générer toutes les chaines de caractère et les traduire
- [ ] Mise à jour de l'API/instructions pour Blockly
** 02 juin
*** Activité
...
- [X] Gestion des retours d'erreur
  - Aucun cas pour le moment, à remettre si on en découvre un
- [ ] Gestion de la traduction
  - Générer toutes les chaines de caractère et les traduire
- [ ] Mise à jour de l'API/instructions pour Blockly
** 01 juin
