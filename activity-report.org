...
- Base WebPLM
  - https://github.comb.com/matthieunicolas/webPLM
- Fork WebPLM
...
* Utilisation
** WebPLM
- Ce reporting fait réference à un , ce projet est une version de WebPLM utilisant Blockly comme un langages de programmation. Il utilise Play Framework en Back-end et AngularJS en front-end.
** Démarrage
- Il est d'abord nécessaire d'installer Play Framework
- Puis de cloner le dépôt WebPLM
